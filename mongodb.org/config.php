...
*/
$MONGO["servers"][$i]["mongo_name"] = "At";//mongo server name
$MONGO["servers"][$i]["mongo_host"] = "127.0.0.1";//mongo host
//$MONGO["servers"][$i]["mongo_host"] = "10.0.10.87";//mongo host
...
$MONGO["servers"][$i]["control_users"]["yoka"] = "yoka.com";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
...
$MONGO["servers"][$i]["mongo_name"] = "Fan";//mongo server name
$MONGO["servers"][$i]["mongo_host"] = "10.0.10.161";//mongo host
$MONGO["servers"][$i]["mongo_port"] = "27017";//mongo port
$MONGO["servers"][$i]["mongo_timeout"] = 0;//mongo connection timeout
$MONGO["servers"][$i]["mongo_auth"] = false;//enable mongo authentication?
